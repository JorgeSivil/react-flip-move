...
## Gotchas
  ...
  * If you have a big vertical list, and you are experiencing automatic scrolling issues when reorder an item (i.e. the browser scrolls to the moved item's position), you can add style={{ overflowAnchor: 'none' }} to the container element (e.g. <ul>) to prevent this issue.
